...
This was the first paper where we proposed gradient-based attacks against machine learning (at training time), followed one year later by our [ECML PKDD 2013 paper on evasion attacks (at test time)](https://arxiv.org/abs/1708.06131). 
The same idea of using gradient-based attacks on machine learning was independently rediscovered one year later to demonstrate [_adversarial examples_](https://arxiv.org/abs/1312.6199) on deep neural networks.
